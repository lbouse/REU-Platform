...
public class Platform_newProject extends javax.swing.JInternalFrame {
    ...
    **/
    ...
    public void buildStepTwo( final String pName, final String srcType ) throws ClassNotFoundException, SQLException, ParserException
    {
        projName = pName;
        ...
        { buildStepTwoC(projName, srcType, stepNumber); }
    ...
    //StepTwoC, source type: Website
    public void buildStepTwoC(String projName, String srcType, int stepNum) throws ParserException
    {
        mainPanel.add( Box.createRigidArea(new Dimension(0, 3)) );
        headerPanel.setAlignmentX(Component.LEFT_ALIGNMENT);
        mainPanel.add(headerPanel);

        final createNewProjectWeb s = new createNewProjectWeb();
        s.dbPanel.setAlignmentX(Component.LEFT_ALIGNMENT);
        mainPanel.add(s.dbPanel);
...
//            { isMissing = true; missing += "Destination\n"; }
    ...
    public void optionBtnEvent(ActionEvent e) throws ClassNotFoundException, SQLException, ParserException
