...
public class OracleController {
    ...
    /* Public Methods */
    public void LoadOraclePlugin() throws ClassNotFoundException
    { Class.forName("oracle.jdbc.driver.OracleDriver"); }
    
    public void ConnectToServer() throws SQLException
    { //"jdbc:mysql://localhost:3306/test", "root", "");
        conn = DriverManager.getConnection("jdbc:oracle:thin:@//localhost:1521/test", "root", "");
    }
    ...
    {
        conn = DriverManager.getConnection("jdbc:oracle:thin:@//localhost:1521/" + database, "root", "");
    }
