...
public class PostgreController {
    ...
    /* Public Methods */
    public void LoadPostgrePlugin() throws ClassNotFoundException
    { Class.forName("org.postgresql.Driver"); }
    
    public void ConnectToServer() throws SQLException
    { conn = DriverManager.getConnection("jdbc:postgresql://localhost:5432/test", "root", ""); }
    ...
    {
        conn = DriverManager.getConnection("jdbc:postgresql://localhost:5432/" + database, "root", "");
    }
